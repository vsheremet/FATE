...
def get_fvcom_gom3_grid(a='disk'):
    ...
    # quick load from disk
        ...
        # try monthly files instead of the aggregated 30yr hindcast
        #URL='http://www.smast.umassd.edu:8080/thredds/dodsC/models/fvcom/NECOFS/Archive/gom3_200101.nc'        
        # the above no longer works        
        URL='http://www.smast.umassd.edu:8080/thredds/dodsC/models/fvcom/NECOFS/Archive/NECOFS_GOM3_2012/gom3v12_201201.nc'
